...
pub const STATE_LAST_PAYOUT       : &str = "lastPayout";
pub const STATE_OWNER             : &str = "owner";
pub const STATE_PAYOFF_KEYS_FRAC  : &str = "payoffKeysFrac";
pub const STATE_PAYOFFS_FRAC      : &str = "payoffsFrac";
...
pub const FUNC_PAYOUT_FRAC                  : &str = "payoutFrac";
...
pub const HFUNC_PAYOUT_FRAC                  : ScHname = ScHname(0x363bbfc5);
